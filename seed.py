...
with app.app_context():
    ...
    products = [
        ...
        Product(name="RadiantGuard Sensor Lamp", price=699, category="Solar Wall Light", stock_quantity=100, image_url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGJiX1U-dGICpkL7ndl7BvnLBcotFVpo77OA&s", functionality="Wall-mounted with motion sensor"),
        ...
        Product(name="RadiantMini LED", price=299, category="Solar Wall Light", stock_quantity=150, image_url="https://m.media-amazon.com/images/I/71I3wrcGxVL._AC_UF1000,1000_QL80_.jpg", functionality="Compact and bright for small areas"),
        ...
        Product(name="Solar Street Light Outo Wall Light", price=199, category="Solar Street Light", stock_quantity=200, image_url="https://ke.jumia.is/unsafe/fit-in/500x500/filters:fill(white)/product/87/7486412/1.jpg?3618", functionality="Street light with wide coverage"),
