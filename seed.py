...
with app.app_context():
    ...
    products = [
        ...
        Product(name="SunTrail Eco Street Light", price=299, category="Solar Street Light", stock_quantity=190, image_url="https://fireflier.com/wp-content/uploads/2021/05/remote-control-solar-street-lighting.jpg", functionality="Energy efficient with remote control"),
