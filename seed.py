...
with app.app_context():
    ...
    products = [
        ...
        Product(name="RadiantBeam Titan", price=9, category="Solar Panel light", stock_quantity=50, image_url="https://atlas-content-cdn.pixelsquid.com/stock-images/solar-panel-cell-RB7AlaB-600.jpg", functionality="Portable design with high efficiency"),
